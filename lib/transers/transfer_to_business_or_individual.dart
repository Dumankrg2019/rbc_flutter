...
class TransferToBusinesOrIndividualScreen extends StatelessWidget {
  @override
    ...
    return Scaffold(
      appBar: AppBar(
       backgroundColor: Colors.white,
        ...
        title: Text('На счет юр. и физ. лицам'),
        centerTitle: true,
      ),
      body: Container(
        color: Colors.white,
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            _buildAccountSelector('Счет получателя (IBAN)', iconUrl: "assets/images/little_card.svg"),
            SizedBox(height: 32),
            Container(
                height: 64,
                child: TextField(
