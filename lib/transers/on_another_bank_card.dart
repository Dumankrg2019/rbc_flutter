...
class TransfTAntherankCardScreen extends StatelessWidget {
  @override
    ...
    return Scaffold(
      appBar: AppBar(
       backgroundColor: Colors.white,
        ...
        title: Text('На карут любого банка'),
        centerTitle: true,
      ),
      body: Container(
        color: Colors.white,
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            _buildAccountSelector('Номер карты', iconUrl: "assets/images/little_card.svg"),
            SizedBox(height: 32),
            Container(
                height: 64,
                child: TextField(
